      ...
      <div className='legal responsive-width'>
        ...
        <ul className='legal__list'>
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>Affiliate</strong> means an entity that controls, is controlled by or is
          ...
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>Company</strong> (referred to as either &quot;the Company&quot;,
              &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Google.
            </p>
          </li>
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>Device</strong> means any device that can access the Service such as a
          ...
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>Third-party Social Media Service</strong> means any services or content
          ...
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>You</strong> means the individual accessing or using the Service, or the
        ...
        <p>
          ...
          party&apos; liability will be limited to the greatest extent permitted by law.
        </p>
        ...
        <p>
          Without limiting the foregoing, neither the Company nor any of the company&apos; provider makes any
        ...
        <p>
          ...
          these Terms shall not effect a party&apos; ability to exercise such right or require such performance at any
