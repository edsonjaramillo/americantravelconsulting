...
import SYTA from '@/public/syta.png';
  ...
  <footer className='footer'>
    <div className='footer__grid'>
      ...
      <div className='footer__syta'>
        <Image src={SYTA} alt='SYTA' quality={30} />
      </div>
      ...
      <small className='footer__copyright'>
        &copy;{copyrightYear()}, American Travel Consulting LLC. All Rights Reserved.
      </small>
    </div>
  </footer>
);
...
const InstagramIcon = () => (
  <FooterSocialIcon href='https://www.instagram.com/americantravelconsulting/' name='Instagram'>
...
const FacebookIcon = () => (
  <FooterSocialIcon href='https://www.facebook.com/AmericanTravelConsulting/' name='Facebook'>
    <svg height='100%' viewBox='0 0 512 512' width='100%' xmlns='http://www.w3.org/2000/svg'>
